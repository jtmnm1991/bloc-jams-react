    ...
    <Col xs={12} className="selling-points">
      ...
      <Col xs={12}>
        <Col sm={8} smOffset={2} xs={12} className="point one">
          <h3 className="point-title">Choose your music <span className="icon ion-ios-musical-notes custom-icon"></span></h3>
          <Col sm={8} smOffset={2} xs={12} className="point-description one">
            <p>The world is full of music; why should you have to listen to music that someone else chose?</p>
          </Col>
        </Col>
        <Col sm={8} smOffset={2} xs={12} className="point two">
          <h3 className="point-title">Unlimited, streaming, ad-free <span className="icon ion-thumbsup custom-icon"></span></h3>
          <Col sm={8} smOffset={2} xs={12} className="point-description two">
            <p>No arbitrary limits. No distractions.</p>
          </Col>
        </Col>
        <Col sm={8} smOffset={2} xs={12} className="point three">
          <h3 className="point-title">Mobile enabled <span className="icon ion-earth custom-icon"></span></h3>
